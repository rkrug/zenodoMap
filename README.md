...
Source code for a minimal [Shiny app](https://rmkrug.shinyapps.io/shiny_zenodmap/) to explore Zenodo records as a network graph but can also be run locally. 

# AI Usage disclaimer
The development of this app was mainly done by ChatGPT 5.2 (CODEX extension in Positron). There has not been any detailed code review yet.
